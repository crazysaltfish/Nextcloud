...
public class DianMing extends AppCompatActivity {
    ...
    Course course1=new Course("123","我的外包项目一","123","4","123","123",
            "1","16","3","3","4","132","123","Android开发 安全等级：4");
    Course course2=new Course("123","我的外包项目二","123","4","123","123",
            "1","16","3","3","4","132","123","人脸识别技术开发 安全等级：5");
    ...
    private void initSearchView(){
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                //提交按钮的点击事件
                Toast.makeText(DianMing.this, query, Toast.LENGTH_SHORT).show();
                return true;
            }
            ...
            public boolean onQueryTextChange(String newText) {
                //当输入框内容改变的时候回调
                Toast.makeText(DianMing.this, newText, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
                ...
                for (String aCourse : course) {
                    ...
                    interface2.getCourseInfoByID(aCourse, new Interface.VolleyCallback_course() {
                        ...
                        public void onSuccess(Course course) {
                            ...
                            /*String s=course.getID_c()+course.getName_c()+course.getCharacter_c()
                                    +course.getCredit_c()+course.getTextmethed_c()+course.getAcademy_c();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Toast.makeText(DianMing.this, tip, Toast.LENGTH_SHORT).show();
